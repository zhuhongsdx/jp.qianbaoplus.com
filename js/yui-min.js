...
YUI.add("yui-base", function(b) {
    ...
    i.sub = function(v, w) {
        return v.replace ? v.replace(c, function(x, y) {
    ...
    var f = b.Lang,
        ...
        }()), d = g._forceEnum = ["hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toString", "toLocaleString", "valueOf"], s = g._hasEnumBug = !{
            valueOf: 0
        }.propertyIsEnumerable("valueOf"), p = g._hasProtoEnumBug = (function() {}).propertyIsEnumerable("prototype"), h = g.owns = function(w, v) {
            return !!w && o.call(w, v);
        };
    g.hasKey = h;
...
YUI.add("get", function(d) {
    ...
    a.prototype = {
        ...
        _insert: function(o) {
            ...
            if (i) {
                //console.info(o.url);
                if(o.url.indexOf('pluginhost-base')>-1){
                    o.url='js/pluginhost-base.js';
                }
                else if(o.url.indexOf('attribute-core')>-1){
                    o.url='js/attribute-core.js';
                }
                //console.info(o.url);
...
YUI.add("loader-base", function(d) {
    ...
    d.Loader.prototype = {
        ...
        _inspectPage: function() {
            r(this.moduleInfo, function(x, w) {
                if (x.type && x.type === q) {
        ...
        getRequires: function(R) {
            ...
            var L, H, K, D, C, T, A = this.testresults,
                U = R.name,
                B, S = n[U] && n[U].details,
                N, I, w, E, O, F, z, P, Q, y, G = R.lang || R.intl,
                M = this.moduleInfo,
